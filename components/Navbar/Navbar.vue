<template>
    <nav x-data="{ isOpen: false }" class="z-10 fixed top-0 w-full bg-white shadow dark:bg-gray-900 border-violet-400 border-b-2">
        <div class="px-3 py-2 mx-auto md:flex md:justify-between md:items-center">
            <div class="flex">
                <NuxtLink to="/home" class="app-title text-2xl font-bold dark:text-white hover:opacity-80">
                    PhotoPlace
                </NuxtLink>
    ...
    <div 
        ...
        <a href="#" class="flex items-center p-3 text-sm text-red-600 capitalize transition-colors duration-300 transform dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
            <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
